...
export const Hero = () => {
  return (
    <div>
      ...
      <div className="text-white mt-44 py-4">
        <TextGenerateEffect
          words=" I'm Masum ,
frontend developer based in Chittagong"
          className="text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-green-500 text-[40px] md:text-5xl lg:text-6xl"
        />
